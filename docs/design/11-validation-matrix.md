...
| **Outcome functionals on the effect API** (OQ-11): `quantile` recovers a sigma-path tail effect; functional decomposition legs non-degenerate + close; analytic closed forms exact (gaussian/poisson) | hand engines (gaussian/poisson) | kernel | **V-74, V-75, V-76** |
